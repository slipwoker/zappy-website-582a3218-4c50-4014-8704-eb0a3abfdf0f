    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "איציק יקותיאל-סוכן ביטוח האישי שלך משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '582a3218-4c50-4014-8704-eb0a3abfdf0f',
                    name: data.name || '',
                    email: data.email || '',
